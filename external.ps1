...
$App = Invoke-RestMethod -Method GET -Uri "https://graph.microsoft.com/v1.0/applications?`$filter=displayName eq '$(${Env:azureADApplicationName})'" -Headers $Headers -ContentType "application/json"
